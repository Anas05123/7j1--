    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``My ID``' , `[ ${client.user.id} ]` , true)
			      ...
			      .setFooter('By | anas2005 and traizy helps')
    })
}
});
...
google({ query: input, enableConsole: true }).then(results => {
...
client.on('message', message => { 
    ...
    .setFooter(`7j1-حجي`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/oauth2/authorize?&client_id=533369257589866506&scope=bot&permissions=8`)
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/2WPG3mZ**")
